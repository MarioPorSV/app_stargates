...
<div class="container">
    ...
    <div class="card text-center ">
        <div class="card-header bg-white">
            <h4 class="color-text-header font-weight-bold">SEGUIMIENTO </h4>
        </div>
        <div class="card-body">
                        ...
                        <div class="box">
                            <div class="container-1">
                                ...
                                <input type="search" id="search" name="search" placeholder="Buscar..."
                                    class="form-control" style="font-size:20px ;color:#787B7E"" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">

                        <button type="button" class="btn btn-warning btn-lg mt-0" style="float:left;margin-left:0;background:#F15A29;color:aliceblue"
